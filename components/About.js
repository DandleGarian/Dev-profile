        ...
        <div className='col-span-2'>
          ...
          <div className='flex flex-col md:hidden'>
            <p className='py-sm'>
              ...
              application called Turtle Academy. That's right, the children's
              programming education platform -- that Turtle Academy. You see, I
              ...
              learning HTML, CSS and Javascript as an adult. One year ago, it
              was clear my teaching career had run its course. I decided it was
              time to spin this little coding hobby into a new career.
            </p>
            <div className='w-screen h-[30rem] -ml-[50vw] -mr-[50vw] left-1/2 right-1/2 shadow-xl p-md relative'>
              <Image
            ...
            <p className='py-sm'>
              ...
              continuing to deliver amazing themes to clients, new and old. When
          ...
          {/* end mobile view */}
          <p className='hidden md:block py-sm'>
